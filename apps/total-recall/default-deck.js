(function () {
  window.totalRecallDefaultDeck = {
    name: 'SparkNotes SAT Vocabulary',
    source: 'https://img.sparknotes.com/content/testprep/pdf/sat.vocab.pdf',
    entries: [
    ...
    "adhere 1. (n.) to stick to something 2. (n.)",
    ...
    "buttress 1. (v.) to support, hold up 2.",
    ...
    "calumny (n.) an attempt to spoil someone elses reputation by spreading lies",
    ...
    "compliant (adj.) ready to adapt oneself to anothers wishes",
    "complicit (adj.) being an accomplice in a wrongful act",
    "compliment (n.) an expression of esteem or approval",
    "compound 1. (v.) to combine parts 2. (n.) acombination of different parts 3. (n.) awalled area containing a group of buildings",
    ...
    "consign (v.) to give something over to anothers care",
    ...
    "deface (v.) to ruin or injure somethings appearance",
    "defamatory (adj.) harmful toward anothers reputation",
    "defer (v.) to postpone something; to yield to anothers wisdom",
    "deferential (adj.) showing respect for anothers authority",
    ...
    "demagogue (n.) a leader who appeals to a peoples prejudices",
    ...
    "diligent (adj.) showing care in doing ones work",
    ...
    "disdain 1. (v.) to scorn, hold in low esteem 2. (n.)",
    ...
    "eminent 1. (adj.) distinguished, prominent, famous 2. (adj.)",
    "emollient (adj.) soothing",
    "emote (v.) to express emotion",
    "empathy (n.) sensitivity to anothers feelings as if they were ones own",
    "empirical 1. (adj.) based on observation or experience",
    "emulate (v.) to imitate",
    "enamor (v.) to fill with love, fascinate, usually used in passive form followed by of or with",
    "encore (n.) the audiences demand for a repeat performance; also the artists performance in response to that demand",
    ...
    "expedient (adj.) advisable, advantageous, serving ones self-interest",
    ...
    "incendiary 1. (n.) a person who agitates 2. (adj.)",
    ...
    "larceny (n.) obtaining anothers property by theft or trickery",
    ...
    "manifest 1. (adj.) easily understandable, obvious 2.",
    ...
    "mores (n.) the moral attitudes and fixed customs of a group of people.",
    ...
    "officious (adj.) offering ones services when they are neither wanted nor needed",
    ...
    "platitude (n.) an uninspired remark, cliche",
    ...
    "pungent (adj.) having a pointed, sharp qualityoften used to describe smells",
    ...
    "solvent 1. (n.) a substance that can dissolve other substances 2.",
