...
const datasetConfigs = [
  ...
  },
  {
    id: 'slang',
    label: 'Slang',
    datasetFile: 'apps/slang/slang.js',
    manifestFile: 'data/slang-manifest.json',
    embeddings: [
      'data/slang-embeddings.json',
      'data/slang-embeddings-hfspace.json',
      'data/slang-embeddings-synthetic128.json',
    ],
    similarityReports: [
      'data/similarity-report-slang.json',
      'data/similarity-report-slang-hfspace.json',
      'data/similarity-report-slang-s128.json',
    ],
    sources: [],
  },
];
